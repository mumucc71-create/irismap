(function () {
  ...
  const FIREBASE_CONFIG_SCRIPT = "firebase-config.js?v=20260710-referrer-required-1";
  const FIREBASE_SYNC_SCRIPT = "firebase-sync.js?v=20260710-referrer-required-1";
  const ROUTES = {
